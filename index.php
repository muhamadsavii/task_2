...
fscanf(STDIN, "%s \n", $jwb);
if($jwb == "start") {
while ((($player->get_mana() > 0 && $player->get_blood() > 0) || ($player2->get_mana() > 0 && $player2->get_blood() > 0)) && (($player->get_mana() > 0 && $player2->get_mana() > 0) || ( $player->get_blood() > 0 && $player2->get_blood() > 0))) {
echo '
# ===================================== #
# Welcome to the Battle Arena           #
# ------------------------------------- #
